        ...
        children: [
            ...
            },
            {
                ...
                children: [
                    ...
                    // { path: '/operationSupport/operationSupportOne/user', component: user, name: '礼物管理', hidden: false, meta: { role: ['admin', 'testP1'] } },
            ...
            },
            {
                ...
                children: [
                    ...
                    { path: '/operationSupport/operationSupportOne/user', component: user, name: 'banner条管理', hidden: false, meta: { role: ['admin', 'testP1'] } },
